...
namespace WeatherInformer.Converters
{
    public class WeatherIconConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var timePeriod = iconId.ToCharArray()[2]; // either d or n (day or night)
            const string pack = "pack://application:,,,/OpenWeather;component/WeatherIcons/";
